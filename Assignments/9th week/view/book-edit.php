...
<form action="<?= BASE_URL . "book/edit" ?>" method="post">
    ...
    <p><label>Author: <input type="text" name="author" value="<?= $book["author"] ?>" autofocus pattern="[A-Za-z\s\.\-]+" required/>
    ...
    <p><label>Price: <input type="number" name="price" value="<?= $book["price"] ?>" min="0" />
